...
| 0021 | 2026-09-24 | Accepted | [games.yaml の schema は JSON Schema を正にし、pydantic モデルを生成する](references/0021-games-yaml-schema-first.md) | games.yaml / `meta.yaml` / front matter の schema、生成ツールやその設定、生成物のずれの検出方法を変えるとき |
